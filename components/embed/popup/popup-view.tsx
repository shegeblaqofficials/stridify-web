...
import useChatAndTranscription from "@/hooks/embed/use-chat-and-transcription";
    ...
    >
      <div className="relative flex h-full shrink-1 grow-1 flex-col">
        <TranscriptMotion
          ...
          animate={{ y: chatOpen ? 0 : 10, opacity: chatOpen ? 1 : 0 }}
        ...
        <AnimatePresence>
          {!agentVideoTrack && (
            <motion.div
              ...
              animate={{
                left:
                  chatOpen && (isCameraEnabled || isScreenShareEnabled)
                    ? "39%"
                    : "50%",
              ...
              className={cn(
                ...
                chatOpen &&
                  "border-separator1 dark:border-separator2 drop-shadow-2xl",
              )}
            >
              <AudioVisualizer
          ...
          {agentVideoTrack && (
            <motion.div
              ...
              transition={{
                ...
                maskImage: { ease: "linear", duration: 1 },
                filter: { ease: "linear", duration: 1 },
              }}
